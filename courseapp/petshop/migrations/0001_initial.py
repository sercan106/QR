    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('kullanici', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='petshop_profili', to=settings.AUTH_USER_MODEL)),
            ],
            options={
